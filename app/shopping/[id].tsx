import { View, Text, Pressable, StyleSheet, ScrollView, Platform, Image, Share, ActivityIndicator } from 'react-native';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.info}>
          ...
          <View style={styles.ratingRow}>
            {[1,2,3,4,5].map(s => <Ionicons key={s} name={s <= Math.floor(store.rating ?? 0) ? "star" : "star-outline"} size={20} color={Colors.accent} />)}

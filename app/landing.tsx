...
const CITIES = [
  ...
  { name: 'Auckland',  color: ['#00A651', '#006B35'] as [string, string] },
  { name: 'Dubai',     color: ['#9B59B6', '#6C3483'] as [string, string] },
  { name: 'London',    color: ['#E74C3C', '#922B21'] as [string, string] },
  { name: 'Toronto',   color: ['#2E86C1', '#1B4F72'] as [string, string] },
  { name: 'Vancouver', color: ['#17A589', '#0E6655'] as [string, string] },
];
      ...
      >
        ...
        >
          <View style={[heroStyles.content, { paddingHorizontal: hPad, maxWidth: maxContentWidth, alignSelf: 'center', width: '100%' }]}>
            <View style={heroStyles.badge}>
              <Ionicons name="globe-outline" size={14} color="#FCB131" />
              <Text style={heroStyles.badgeText}>Australia · NZ · UAE · UK · Canada</Text>
            </View>
        ...
        <View style={[footerStyles.footer, { borderTopColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.06)', paddingHorizontal: hPad }]}>
          ...
          <Text style={[footerStyles.copy, { color: isDark ? 'rgba(232,244,255,0.35)' : 'rgba(0,22,40,0.35)' }]}>
            © 2025 CulturePass. All rights reserved.
          </Text>
        </View>
      </ScrollView>
    </View>

...
export default function EventDetailScreen() {
  ...
  return (
    <ErrorBoundary>
      <EventDetail event={event} topInset={topInset} bottomInset={bottomInset} />
    </ErrorBoundary>
  );
}
...
function EventDetail({ event, topInset, bottomInset }: EventDetailProps) {
  ...
  const handleDiscoveryFeedback = useCallback(async (signal: 'up' | 'down') => {
    if (!userId) return;
          ...
          <View style={styles.heroNav}>
            ...
            <View style={styles.heroActions}>
              ...
              <Pressable
                ...
                onPress={() => confirmAndReport({ targetType: 'event', targetId: String(event.id) })}
              >
      ...
      >
          ...
          <>
            ...
            <View style={styles.section}>
              ...
              {feedbackSubmitted ? (
                ...
                <>
                  <Text style={styles.feedbackPrompt}>How was {event.title}?</Text>
                    ...
                    {[1, 2, 3, 4, 5].map((star) => (
                      ...
                      >
                        <Ionicons
                          ...
                          size={32}
                          color={star <= feedbackRating ? '#F39C12' : Colors.textTertiary}
                        />
                      </Pressable>
                    ))}
                  </View>
        ...
        <View style={[styles.section, styles.discoveryFeedbackRow]}>
          ...
          <View style={styles.discoveryFeedbackBtns}>
            ...
            >
              <Ionicons name="thumbs-up-outline" size={20} color={Colors.secondary} />
              <Text style={[styles.discoveryFeedbackBtnText, { color: Colors.secondary }]}>Yes</Text>
            </Pressable>
            <Pressable
              style={styles.discoveryFeedbackBtn}

  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Pressable onPress={handleSkip} style={styles.skipButton} accessibilityLabel="Skip onboarding">
...
const styles = StyleSheet.create({
  ...
  tagline: {
    ...
    color: 'rgba(255,255,255,0.55)', marginTop: 6, letterSpacing: 1.5,
  ...
  featureText: { fontSize: 14, fontFamily: 'Poppins_500Medium', color: 'rgba(255,255,255,0.85)', flex: 1 },
  ...
  primaryButtonText: { color: '#001028', fontSize: 17, fontFamily: 'Poppins_700Bold' },
  ...
  secondaryButtonText: { color: '#FFFFFF', fontSize: 15, fontFamily: 'Poppins_600SemiBold' },
  ...
  socialText: { fontSize: 14, fontFamily: 'Poppins_600SemiBold', color: '#FFFFFF' },

  skipButton: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: 6, paddingVertical: 12,
  },
  skipText: { fontSize: 14, fontFamily: 'Poppins_500Medium', color: 'rgba(255,255,255,0.4)' },
});
